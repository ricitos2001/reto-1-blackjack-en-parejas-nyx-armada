...
from src.blackjackcompleto import crear_resultadosolitario
from src.blackjackcompleto import crear_resultadomultijugador
...
@pytest.mark.parametrize(
    ...
    [
        (['K', 'A'],['Q', 9],"\ntu tienes ['K', 'A'] para un total de 21 puntos y el distribuidor tiene ['z', 9] para un total de 19 puntos\nBlackjack: jugador gana!"),
